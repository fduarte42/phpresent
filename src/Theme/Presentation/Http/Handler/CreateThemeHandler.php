...
use Phpresent\Theme\Application\Command\CreateThemeHandler as CreateThemeCommandHandler;
...
final readonly class CreateThemeHandler implements RequestHandlerInterface
{
    public function __construct(private CreateThemeCommandHandler $createThemeHandler)
    {
    }
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            $theme = ($this->createThemeHandler)(new CreateThemeCommand(
        ...
        return new JsonResponse(['data' => $theme], 201);
    }
}
