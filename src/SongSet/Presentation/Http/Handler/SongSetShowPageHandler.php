...
/**
 * Inertia page handler for a single Song Set, including its ordered,
 * song-resolved items for the drag/drop reorder UI (see §17.6).
 */
final readonly class SongSetShowPageHandler implements RequestHandlerInterface
{
    public function __construct(
        private GetSongSetQueryHandler $getSongSetHandler,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return $this->inertia->render($request, 'SongSets/Show', [
            'songSet' => $songSet,
        ]);
    }
}
